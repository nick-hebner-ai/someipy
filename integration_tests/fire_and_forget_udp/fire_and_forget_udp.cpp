...
// Sends fire-and-forget (REQUEST_NO_RETURN) method calls to a service offered
// by the someipy application. The someipy side must receive and dispatch these
// to its method handler; no response is expected or sent.
...
public:
    ...
    bool init()
    {
        ...
        // Mark the message as fire-and-forget. vsomeip then emits a SOME/IP
        // message with type REQUEST_NO_RETURN (0x01) and expects no response.
        ...
        while (true)
        {
            ...
            if (send_data)
            {
                ...
                std::cout << "Client/Session ["
                          ...
                          << "] sent a fire-and-forget request to Service ["
